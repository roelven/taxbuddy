...
class Build(object):
	...
	def __init__(self, config, source_dir, output_dir, external=True, remove_attribution=True, usercode=None,
			ignore_patterns=None, enabled_platforms=('chrome', 'firefox', 'safari', 'ie', 'android', 'web', 'wp'),
