...
def generate_app_from_template(generate_module, build_to_run, server=False):
	...
	if os.path.isdir('hooks/prebuild'):
		...
		build_to_run.add_steps(generate_module.customer_phases.copy_user_source_to_template(server=server, ignore_patterns=build_to_run.ignore_patterns, src=tempdir))
		# Delete temp dir
